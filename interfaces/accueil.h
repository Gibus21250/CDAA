...
/**
 * @brief Classe gérant la page d'acceuil de l'application
 */
...
private:
    ...
    ///Variable stockant le nombre de Contact visible
    int nbVisible;
...
public:
    ...
    /**
     * @brief Constructeur standard de l'Accueil
     * @param parent Pointeur vers un widget parent
     */
